...
@Controller
public class AdminMernaTraka5Controller {

    @Autowired
    MernaTraka5Service mernaTraka5Service;


    @RequestMapping("/admin/adminMernaTraka5")
    public String getMernaTraka30(){
        return "/admin/adminMernaTraka5";
    }

    @RequestMapping(path = "/admin/adminMernaTraka5/{rec}")
    public String getMT5(@PathVariable("rec") String rec, Model model,MernaTraka5DTO mernaTraka5DTO){
        ...
        String s = "/admin/admin/adminMernaTraka5";
        return s;

    }

    @PostMapping("/admin/adminMernaTraka5/{rec}")

...
public class PM100Controller {
    ...
    @RequestMapping("/worker/pm100")
    public String getPM100(){
        return  "/worker/pm100";
    }

    @RequestMapping(path = "/worker/pm100/{mp}/{rec}")
    public String getPM100(@PathVariable("rec") String rec,@PathVariable("mp") String mp, Model model){
        ...
        String s = "/worker/pm100";
        return s;

    }

    @PostMapping("/worker/pm100/{mp}/{rec}")
    public String postPM100(Model model,

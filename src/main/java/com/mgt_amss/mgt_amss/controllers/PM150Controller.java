...
public class PM150Controller {
    ...
    @RequestMapping("/worker/pm150")
    public String getPM150(){
        return "/worker/pm150";
    }

    @RequestMapping(path = "/worker/pm150/{mp}/{rec}")
    public String getPM150(@PathVariable("rec") String rec, @PathVariable("mp") String mp, Model model){
        ...
        String s = "/worker/pm150";
        return s;

    }

    @PostMapping("/worker/pm150/{mp}/{rec}")
    public String postPM150(Model model,

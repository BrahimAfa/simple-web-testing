...
@Controller
public class AdminKvk2Controller {

    @Autowired
    Kvk2Service kvk2Service;

    @RequestMapping("/admin/adminKvk2")
    public String getKvk1(){
        return "/admin/adminKvk2";
    }

    @RequestMapping(path = "/admin/adminKvk2/{rec}")
    public String getKvk2(@PathVariable("rec") String rec, Model model, KontrolnikVucneKuke2DTO kontrolnikVucneKuke2DTO){
        ...
        String s = "/admin/adminKvk2";
        return s;

    }

    @PostMapping("/admin/adminKvk2/{rec}")

...
@Controller
public class AdminMernaTraka30Controller {

    @Autowired
    MernaTraka30Service mernaTraka30Service;

    @RequestMapping("/admin/adminMernaTraka30")
    public String getAdminMernaTraka30(){
        return "/admin/adminMernaTraka30";
    }

    @RequestMapping(path = "/admin/adminMernaTraka30/{rec}")
    public String getMT30(@PathVariable("rec") String rec, Model model, MernaTraka30DTO mernaTraka30DTO){
        ...
        String s = "/admin/adminMernaTraka30";
        return s;

    }

    @PostMapping("/admin/adminMernaTraka30/{rec}")

...
public class RecordDTO {
    ...
    public void setMerio(int merio) {
        this.merio = merio;
    }

    public int getOdobrio() {
        return odobrio;
    }

    public void setOdobrio(int odobrio) {
    ...
    public LocalDate getDatumAMSS() {
        return datumAMSS;
    }

    public void setDatumAMSS(LocalDate datumAMSS) {

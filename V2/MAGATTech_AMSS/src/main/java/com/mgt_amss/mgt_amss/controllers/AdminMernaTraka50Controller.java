...
@Controller
public class AdminMernaTraka50Controller {

    @Autowired
    MernaTraka50Service mernaTraka50Service;

    @RequestMapping("/admin/mernaTraka50")
    public String getAdminMernaTraka50(){
        return "/admin/mernaTraka50";
    }

    @RequestMapping(path = "/admin/adminMernaTraka50/{rec}")
    public String getMT50(@PathVariable("rec") String rec, Model model,MernaTraka50DTO mernaTraka50DTO){
        ...
        String s = "/admin/adminMernaTraka50";
        return s;

    }

    @PostMapping("/admin/adminMernaTraka50/{rec}")

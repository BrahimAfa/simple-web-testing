...
public class PrintController {
    ...
    public String postPrint(Model model,@RequestParam String brojSeta,@RequestParam String predmetEtaloniranja,
        ...
        record.setOdobrio(odobrio);
        record.setPodatkeUneo(etalonirao);
